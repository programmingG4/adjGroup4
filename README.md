...
로컬 환경에 따라 `username`, `password`, `database name`을 수정해야 합니다.
...
Linux / Ubuntu 환경에서는 다음 명령어를 사용합니다.
...
또는 IntelliJ IDEA에서 `CampusonApplication` 파일을 직접 실행할 수 있습니다.

---

## 7. 접속 주소

프로젝트 실행 후 아래 주소로 접속합니다.
...
- GitHub에 업로드하기 전 개인정보나 실제 비밀번호가 포함되지 않았는지 확인해야 합니다.
